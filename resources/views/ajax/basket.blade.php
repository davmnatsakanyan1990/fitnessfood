    ...
    @foreach($products as $product)
        <tr>
            ...
            <td class="text-center">
                <div class="prod-inf">
                    <div class="quantity-wrap clearfix">
                        <div>
                            <form class="quantity-form" method="POST" action="#" data-id="{{ $product['id'] }}" data-price="{{ $product['price'] }}">
                                <div>
            ...
            <td class="text-right td-prc"><span class="amount">{{ $product['price'] * $product['count'] }}</span>@lang('product.amd')</td>
