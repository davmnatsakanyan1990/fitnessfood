...
@endforeach
@else
    <div class="item active" style="background: url(/images/products/noimage.gif); background-repeat: no-repeat; min-height: 500px; background-size: cover; background-position: center center;">
