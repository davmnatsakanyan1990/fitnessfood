...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Edit Recipe - {{ json_decode($recipe->title)->en }}</h2>
        </div>
    </div>
                            ...
                            <div class="ibox-content no-padding">
                                <div class="row">
                                    <div class="col-md-3 title">
                                        ...
                                        <input value="{{  json_decode($recipe->title)->am }}" type="text" name="title[am]" class="form-control" id="am_title">
                            ...
                            <div class="ibox-content no-padding">
                                <div class="row">
                                    <div class="col-md-3 title">
                                        ...
                                        <input value="{{ json_decode($recipe->title)->ru }}" type="text" name="title[ru]" class="form-control" id="ru_title">
                            ...
                            <div class="ibox-content no-padding">
                                <div class="row">
                                    <div class="col-md-3 title">
                                        ...
                                        <input value="{{ json_decode($recipe->title)->en }}" type="text" name="title[en]" class="form-control" id="en_title">
